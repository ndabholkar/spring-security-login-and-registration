...
public class OldRegistrationController {
	...
	@Autowired
	public OldRegistrationController(IUserService userService, MessageSource messageSource, JavaMailSender mailSender,
	...
	private final SimpleMailMessage constructResetVerificationTokenEmail(final String contextPath, final Locale locale, final VerificationToken newToken,
		final User user) {
