...
import org.odyssey.persistence.dao.PrivilegeRepository;
...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
	...
	@Transactional
	protected User createUserIfNotFound(final String email, final String firstName, final String lastName, final String password,
